...
1. Download `YourJobs.exe` from the [Releases](../../releases) section of this repo
2. Double-click `YourJobs.exe` to launch — no Python installation required
...
cd job-application-tracker-widget
pip install -r requirements.txt
python job_tracker_widget.py
```
...
**Problem**: Dependencies not installing (source install only)
- **Solution**:
  ```bash
